...
import { arrow_icon, hero_6, hero_7, hero_8 } from "@/constants";
...
const Hero = () => {
  ...
  return (
    <div className="h-screen w-full p-4 flex mt-16">
      <div className="w-full flex md:flex-row flex-col h-3/5  md:space-x-4 space-y-4 md:space-y-0 relative">
        <div className="w-full md:w-1/4 h-full relative flex flex-col space-y-4 items-center justify-end pt-20">
        ...
        <div className="w-full md:w-1/4 h-full relative flex flex-col space-y-4 items-center justify-end">
          <Link
            href="/events"
        ...
        <div className="w-full md:w-1/4 h-full relative flex flex-col space-y-4 items-center justify-end pt-20">
          <div className="bg-[#cff29e] rounded-2xl w-full h-[70%] px-8 py-6 space-y-4 flex flex-col justify-between">
            <p className="p">20+</p>
